...
import { Search, Filter, AlertCircle, Info, AlertTriangle, Terminal } from "lucide-react";

// Mock data for logs
const initialLogs = [
  { id: "log_1", timestamp: "2023-10-25 14:32:01", level: "info", source: "Auth", message: "User logged in successfully: admin@roisheet.com" },
  { id: "log_2", timestamp: "2023-10-25 14:30:15", level: "info", source: "Supabase", message: "Fetched 15 records from 'automations' table" },
  { id: "log_3", timestamp: "2023-10-25 14:15:22", level: "error", source: "Webhook", message: "Failed to process webhook: wh_123456789. Timeout error." },
  { id: "log_4", timestamp: "2023-10-25 13:55:00", level: "warn", source: "API", message: "Rate limit approaching for endpoint /v1/metrics" },
  { id: "log_5", timestamp: "2023-10-25 13:50:11", level: "info", source: "Supabase", message: "Realtime subscription active: public.logs" },
  { id: "log_6", timestamp: "2023-10-25 13:45:33", level: "info", source: "System", message: "Dashboard widgets initialized" },
  { id: "log_7", timestamp: "2023-10-25 13:40:05", level: "error", source: "Database", message: "Connection lost. Retrying in 5s..." },
];
